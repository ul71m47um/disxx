...
#ifndef WINDOWMODIFIER_SWIFT_H
#define WINDOWMODIFIER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WindowModifier",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("WindowModifier", usrValue)
...
#endif
#ifdef __cplusplus
namespace WindowModifier SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("WindowModifier") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void $s14WindowModifier6WinModC6modifyyyFZ(SWIFT_CONTEXT const void * _Nonnull _self) SWIFT_NOEXCEPT SWIFT_CALL; // modify()
...
class SWIFT_SYMBOL("s:14WindowModifier6WinModC") WinMod;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
inline const constexpr bool isUsableInGenericContext<WindowModifier::WinMod> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_WinMod;
// Type metadata accessor for WinMod
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s14WindowModifier6WinModCMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:14WindowModifier6WinModC") WinMod : public swift::_impl::RefCountedClass {
public:
  using RefCountedClass::RefCountedClass;
  using RefCountedClass::operator=;
  static SWIFT_INLINE_THUNK void modify() SWIFT_SYMBOL("s:14WindowModifier6WinModC6modifyyyFZ");
protected:
  SWIFT_INLINE_THUNK WinMod(void * _Nonnull ptr) noexcept : RefCountedClass(ptr) {}
private:
  friend class _impl::_impl_WinMod;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s14WindowModifier6WinModCD;
  static inline constexpr $s14WindowModifier6WinModCD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_WinMod {
public:
static SWIFT_INLINE_THUNK WinMod makeRetained(void * _Nonnull ptr) noexcept { return WinMod(ptr); }
};
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<WindowModifier::WinMod> {
  static SWIFT_INLINE_PRIVATE_HELPER void * _Nonnull getTypeMetadata() {
    return WindowModifier::_impl::$s14WindowModifier6WinModCMa(0)._0;
  }
};
namespace _impl{
template<>
struct implClassFor<WindowModifier::WinMod> { using type = WindowModifier::_impl::_impl_WinMod; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
namespace WindowModifier SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("WindowModifier") {
  ...
  SWIFT_INLINE_THUNK void WinMod::modify() {
  WindowModifier::_impl::$s14WindowModifier6WinModC6modifyyyFZ(swift::TypeMetadataTrait<WinMod>::getTypeMetadata());
  }

} // namespace WindowModifier
