...
namespace disxx::disasm::decoder::DataProcessingRegister::AddSubstractExtendedRegister
{
	...
	DisassemblyResult SubDecoder::Decode(void) const noexcept
	{
        ...
        opt = utility::bits::extract<unsigned short int, std::uint32_t, 22, 23>(this->m_Insn);
        ...
        imm3 = utility::bits::extract<unsigned short int, std::uint32_t, 10, 12>(this->m_Insn);
