...
module disxx.disasm.decoder.DataProcessingRegister.RotateRightIntoFlags.SubDecoder;
...
namespace disxx::disasm::decoder::DataProcessingRegister::RotateRightIntoFlags
{
