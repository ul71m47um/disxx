module disxx.disasm.decoder.BranchesExceptionsAndSystemInstructions.TestAndBranchImmediate.SubDecoder;
...
namespace disxx::disasm::decoder::BranchesExceptionsAndSystemInstructions::TestAndBranchImmediate
{
